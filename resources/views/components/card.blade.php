...
<div class="card border-0 h-100 w-100">
    <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
      <a href="{{ $url }}">
        <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="{{ Storage::url($image) }}" alt="Living">
      </a>
      <figcaption>
    ...
    <div class="card-body border bg-white p-4">
      <div class="entry-header mb-3">
        <ul class="entry-meta list-unstyled d-flex mb-2">
          <li>
            <a class="link-primary text-decoration-none" href="{{ route('article.bycategory', compact('category')) }}">{{ $category }}</a>
          </li>
        </ul>
      ...
      <p class="card-text entry-summary text-secondary mb-3">
        <a class=" text-decoration-none" href="{{ $url }}">{{ $subtitle }}</a>    </p>

        <a style="" class="position-absolute bottom-0 mb-3 fs-7 link-secondary text-decoration-none d-flex align-items-center" href="#!">
